...
const HomePage = () => {
  return (
    <div className=" w-full bg-[url('/images/101.avif')] bg-center bg-cover h-screen ">
      <div className="  w-screen bg-[#000000b7] h-full z-50 bg-center bg-cover   backdrop-blur-md   ">
        <div className=" lg:flex justify-between px-15 items-center pt-40  ">
          <div className="grid gap-1 text-white bo">
            <h1 className=" text-[90px] font-bold text-white ">Crime 101</h1>
            <div className=" flex gap-2 font-bold text-green-400  items-center">
              ...
              <span>#7 in Nigeria</span>
            </div>

            <div>
              
              <div className="flex gap-3">
                <span  className="bg-[#ffffff33]  w-60  px-4 h-15 rounded-[7px] flex flex-col py-1.5 font-bold font-sans text-[16px] hover:bg-white hover:text-black"  >
                  Watch with Prime 
                  <span>Start your 7-day free trial</span>
                </span>
               
                <div className="flex gap-2">
                  <div className=" bg-[#ffffff33] hover:bg-white hover:text-black rounded-4xl w-16 flex justify-center items-center">
                    <GoPlus className="text-[45px] font-bold" />

                  </div>
                  <div className=" bg-[#ffffff33] hover:bg-white hover:text-black rounded-4xl w-16 flex justify-center items-center">
                    <BsExclamationCircle  className="text-[30px] font-bold"/>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <img src="/images/101.avif" alt="" className="w-150 rounded-2xl " />
        </div>
      </div>
    </div>
  );
